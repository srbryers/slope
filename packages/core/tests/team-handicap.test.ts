...
import {
  ...
  computeTeamHandicap,
} from '../src/team-handicap.js';
import type { GolfScorecard, AgentBreakdown, ShotRecord, HoleStats } from '../src/types.js';
import { computeStatsFromShots } from '../src/builder.js';
