...
import { getMetaphor, hasMetaphor, listMetaphors, golf } from '@slope-dev/core';
 ...
 */
export function resolveMetaphor(args: string[], configMetaphor?: string): MetaphorDefinition {
