...
import { loadReviewState, saveReviewState } from '../src/commands/review-state.js';
import type { ReviewState } from '../src/commands/review-state.js';
...
describe('reviewStateCommand', () => {
  ...
  async function runCommand(args: string[]) {
    const { reviewStateCommand } = await import('../src/commands/review-state.js');
