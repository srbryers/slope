import { computeHandicapCard, computeTeamHandicap, computePlayerHandicaps, filterScorecardsByPlayer } from '../../core/index.js';
import type { MissDirection, PlayerHandicap } from '../../core/index.js';
...
function showPlayerComparison(scorecards: import('../../core/index.js').GolfScorecard[], minSprint: number): void {
...
function showTeamHandicap(scorecards: import('../../core/index.js').GolfScorecard[]): void {
