...
export const NARRATOR_SEGMENTS: Record<string, { text: string; label: string }> = {
  '1a': { label: 'hook',     text: "Hey everyone... this is Slope. It's an AI agent harness and workflow protocol,<break time=\"0.4s\" /> and in this video I'm going to show you how we can set it up on a real project." },
  '1b': { label: 'scan',     text: "All right, so what you can see here is that it's gone through the codebase. It's looked at the stack,<break time=\"0.3s\" /> the structure,<break time=\"0.3s\" /> test coverage,<break time=\"0.3s\" /> all of that,<break time=\"0.4s\" /> and it's put together a full profile of where the project stands today." },
  '2':  { label: 'todo',     text: "Now you can see it's found some \"To-dos\". On bigger projects there could be a lot of these,<break time=\"0.3s\" /> but on smaller ones there might be none. Either way,<break time=\"0.4s\" /> it's going to pull from your codebase and your profile and then ask you some questions." },
  '3a': { label: 'vision',   text: "So you can see here it's asking you to describe your vision. Slope really recommends dictating,<break time=\"0.4s\" /> and the reason I say that is because it's much easier to just talk naturally about what you're trying to build. Feel free to ramble,<break time=\"0.4s\" /> it's going to interpret all of that and pull it together." },
  '3b': { label: 'priorities', text: "You can see here it's pulled out the priorities automatically. You don't have to rank them in a form or anything like that.<break time=\"0.4s\" /> You just talk,<break time=\"0.3s\" /> and it listens." },
  '3c': { label: 'clarify',  text: "And now you can see it's asking some clarifying questions. These aren't generic,<break time=\"0.4s\" /> they're based on what it found in the codebase and what you just told it about your vision." },
  '3d': { label: 'bottleneck', text: "You can see it's digging into the specifics here,<break time=\"0.3s\" /> trying to understand what really matters for this project. It's going to remember things like this when it puts the roadmap together." },
  '3e': { label: 'gap',      text: "And it's also picking up on gaps it found during the profile scan,<break time=\"0.4s\" /> things that might be missing from the project. It'll ask about those directly so it knows what to prioritize." },
  '4a': { label: 'structure', text: "So now it's going to try and put together your vision document. You can see it's laid out the purpose,<break time=\"0.3s\" /> audience,<break time=\"0.3s\" /> priorities,<break time=\"0.3s\" /> non-goals,<break time=\"0.4s\" /> all from that one conversation." },
  '4b': { label: 'checkin',  text: "And this is one of the key things about Slope.<break time=\"0.4s\" /> Once it's done,<break time=\"0.3s\" /> you have the opportunity to review it and push back. We really recommend doing that." },
  '4c': { label: 'pushback', text: "So here you can see the user is pushing back on a few things. Small corrections,<break time=\"0.4s\" /> but these are going to drive every sprint after this,<break time=\"0.3s\" /> so it's really worth getting right." },
  '4d': { label: 'updated',  text: "You can see it's come back with the updates right away.<break time=\"0.4s\" /> No re-doing a form or starting over." },
  '4e': { label: 'locked',   text: "All right,<break time=\"0.3s\" /> so we've agreed with this and we're going to go ahead with it.<break time=\"0.5s\" /> Now watch what it does next." },
  '5a': { label: 'roadmap',  text: "Now what it's going to do is take that whole vision,<break time=\"0.3s\" /> look at your codebase,<break time=\"0.3s\" /> and say,<break time=\"0.3s\" /> well,<break time=\"0.3s\" /> let's see what might be open,<break time=\"0.3s\" /> what could potentially go on this roadmap.<break time=\"0.4s\" /> And then it'll put something together for you." },
  '5b': { label: 'sprint1',  text: "You can see it's breaking it down into sprints. The first one is focused on the top priority,<break time=\"0.4s\" /> and the tickets are coming from both what you said and what it found in the profile." },
  '5c': { label: 'sprints',  text: "And then you've got the rest of the sprints,<break time=\"0.3s\" /> each one focused on a different area of the project. They each get their own sprint with real tickets,<break time=\"0.3s\" /> ready to go." },
  '5d': { label: 'done',     text: "So that's your starting point. Of course,<break time=\"0.4s\" /> you can push back on this roadmap as well,<break time=\"0.3s\" /> but it's a solid foundation to work from." },
  '6a': { label: 'before-after', text: "And this is kind of the before and after. You went from no priorities,<break time=\"0.3s\" /> no structure,<break time=\"0.4s\" /> to a locked-in vision and a full roadmap with Sprint 1 ready to execute." },
  '6b': { label: 'closing',  text: "That's it.<break time=\"0.5s\" /> All from one conversation. If you want to dive deeper,<break time=\"0.4s\" /> I'd recommend booting it up in your agent and using it to refine from there.<break time=\"0.5s\" /> Let me know what you think." },
};
