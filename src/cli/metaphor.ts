...
import { getMetaphor, hasMetaphor, listMetaphors, loadPluginMetaphors, golf } from '../core/index.js';
import type { MetaphorDefinition, PluginsConfig } from '../core/index.js';
