...
export const SLOPE_REGISTRY: FunctionRegistryEntry[] = [
  ...
  // ─── Roadmap ───
  {
    ...
    module: 'core',
    description: 'Validates a roadmap definition for structural correctness (cycles, numbering, ticket counts). See also: computeCriticalPath(), findParallelOpportunities().',
  ...
  },
  {
    ...
    module: 'core',
    description: 'Computes the critical path (longest dependency chain) through the roadmap. See also: findParallelOpportunities(), formatRoadmapSummary().',
  ...
  },
  {
    ...
    module: 'core',
    description: 'Finds sprints that can run in parallel (no mutual dependencies). See also: computeCriticalPath(), formatRoadmapSummary().',
