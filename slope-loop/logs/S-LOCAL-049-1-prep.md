...
- S45-2: "Continuous loop and parallel sprint runners" → green (sprint 45)
- S-LOCAL-040-1: "Harden: store.ts backup/restore" → green (sprint 49)
- S-LOCAL-040-2: "Harden: final tests + CLAUDE.md update" → green (sprint 49)
