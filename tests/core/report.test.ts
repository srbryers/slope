...
import { buildReportData, generateHtmlReport } from '../../src/core/report.js';
...
describe('generateHtmlReport — metaphor awareness', () => {
  ...
  it('loads gaming metaphor', async () => {
    const { gaming } = await import('../../src/core/metaphors/gaming.js');
  ...
  it('golf metaphor produces standard labels', async () => {
    const { golf } = await import('../../src/core/metaphors/golf.js');
    const data = buildReportData(makeScorecards(2));
