...
const SEGMENTS: NarratorSegment[] = [
  ...
  { cue: '1b', words: 40, description: 'scan — "All right, so what you can see here..."' },
  ...
  { cue: '3c', words: 31, description: 'clarify — "And now you can see it\'s asking..."' },
  { cue: '3d', words: 31, description: 'bottleneck — "You can see it\'s digging into..."' },
  { cue: '3e', words: 32, description: 'gap — "And it\'s also picking up on gaps..."' },
  ...
  { cue: '4c', words: 32, description: 'pushback — "So here you can see the user..."' },
  ...
  { cue: '5c', words: 31, description: 'sprints — "And then you\'ve got the rest..."' },
