...
| Water | S241-2 | [security review] CodeQL: polynomial-backtracking regexes in the YAML patcher and incomplete regex-metacharacter escaping of scorecards keys. Practical exposure bounded (keys are numeric, input is repo-local YAML); both hardened with linear parsing and full escaping. |
