...
`docs/backlog/roadmap.json` - Consumed by `slope roadmap validate|review|status|show`. Covers completed S61-S136 catch-up, S137 post-merge retro/durable-memory tooling, S137.5 Windows test-suite portability for #509, completed S138 destructive-help safety for #501, completed S139 existing-worktree recovery for #499, completed S140 session-collision recovery for #502, completed S141 workflow state resync for #503, completed S142 codebase-map non-TS safety for #505, and planned S143-S144 recovery work for open GitHub issue #507.
